...
pub static CLEANUP_CATEGORIES: &[CleanupCategoryDef] = &[
    CleanupCategoryDef {
        ...
        description: "File sementara dari %TEMP%, %LOCALAPPDATA%\\Temp, dan Windows Temp.",
        icon: "📁",
    ...
    CleanupCategoryDef {
        ...
        description: "File log (*.log), crash dump (*.dmp), dan laporan error Windows lama.",
        icon: "📜",
        safety: SafetyLevel::Safe,
        default_enabled: true,
        warning: None,
    ...
    CleanupCategoryDef {
        ...
        title: "Thumbnail Cache Windows",
        description: "Database cache pratinjau thumbnail file explorer. Windows akan meregenerasi otomatis saat dibutuhkan.",
        icon: "🖼️",
        safety: SafetyLevel::Safe,
        default_enabled: true,
        warning: None,
    ...
    CleanupCategoryDef {
        ...
        title: "Isi Recycle Bin",
        description: "File yang sebelumnya dihapus ke Recycle Bin dan masih memakan kapasitas drive Anda.",
        icon: "🗑️",
        safety: SafetyLevel::Safe,
        default_enabled: true,
        warning: Some("File di Recycle Bin akan dikosongkan secara permanen."),
    },
    CleanupCategoryDef {
        id: CleanupCategoryId::DownloadsInstallers,
        title: "Installer & Setup Lama di Downloads (> 60 Hari)",
        description: "File installer (*.exe, *.msi) di folder Downloads yang sudah berumur lebih dari 60 hari.",
        icon: "💿",
